  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '增加http服务',
        meta: { title: '增加http服务', icon: 'component', affix: false },
        hidden: true
      },
      {
        ...
        component: () => import('@/views/service/http'),
        name: '更新http服务',
        meta: { title: '更新http服务', icon: 'component', affix: false },
        hidden: true
      },
      {
        ...
        name: '增加tcp服务',
        meta: { title: '增加tcp服务', icon: 'component', affix: false },
        hidden: true
      },
      {
        ...
        component: () => import('@/views/service/tcp'),
        name: '更新tcp服务',
        meta: { title: '更新tcp服务', icon: 'component', affix: false },
        hidden: true
      },
      {
        ...
        name: '增加grpc服务',
        meta: { title: '增加grpc服务', icon: 'component', affix: false },
        hidden: true
      },
      {
        ...
        component: () => import('@/views/service/grpc'),
        name: '更新grpc服务',
        meta: { title: '更新grpc服务', icon: 'component', affix: false },
        hidden: true
      },
    ]
  }]
